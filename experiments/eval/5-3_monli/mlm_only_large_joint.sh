...
#SBATCH --array=1-5
#SBATCH --job-name=balaur_mlm_only_large_joint
#SBATCH --output=log-balaur_mlm_only_large_joint.log
#SBATCH --nodes=1
...
# script args
args=" \
--model_name=2022_12_20_mlm_only_large \
--experiment_id=2022_12_20_mlm_only_large_joint_snli-seed-${seed} \
